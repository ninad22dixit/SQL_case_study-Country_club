...
SELECT CONCAT_WS(' ',firstname,surname) as member_name, name AS court_name
FROM Members AS m
...
SELECT CONCAT_WS(' ', firstname, surname) AS full_name, name AS facility_name,
CASE 
WHEN firstname = 'GUEST' THEN guestcost
WHEN firstname != 'GUEST' THEN membercost
END AS cost
...
SELECT sub.full_name, sub.name AS facility_name, sub.cost
FROM (SELECT CONCAT_WS(' ', firstname, surname) AS full_name, name,
 CASE 
 WHEN firstname = 'GUEST' THEN guestcost
